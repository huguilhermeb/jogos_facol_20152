...
function camera:unset()
  love.graphics.pop()--volta a escalar de coordenadas padrão
end
...
function camera:setX(value)--codigo comentado define um limite de movimentação da camera
...
function camera:setY(value)--codigo comentado define um limite de movimentação da camera
  if self._bounds then
